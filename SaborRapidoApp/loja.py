...
class SaborRapidoApp:
    def __init__(self, root):
        ...
        self.itens_menu = {"Hamburguer": 10.00, "Batata Frita": 5.00, "Refrigerante": 3.00}
        self.pedido = []
        
        tk.Label(root, text="Selecione os ítens do pedido:", font=("Arial", 12)).pack(pady=10)
    ...
    def adicionar_item_menu(self):
        ...
        if item and preco:
            try:
                ...
                messagebox.showwarning("Sucesso", "Item adicionado ao menu com sucesso!")
            except ValueError:
